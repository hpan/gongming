...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx6d0765e16798812a'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'e584d120fb499492fda62a1282c1a202'),     // AppSecret
     ...
     */
     'oauth' => [
         ...
         'callback' => env('WECHAT_OAUTH_CALLBACK', '/wechat/oauth_callback.php'),
     ],
